...
# Main reference used: https://qiskit.org/textbook/ch-algorithms/bernstein-vazirani.html
...
class BernsteinVazirani():
    ...
    def algorithm(self, draw: bool = False):
        ...
        # Create a circuit with n input qubits plus 1 output qubit, and n classical bits to write the output to
    ...
    def simulation(self, circuit, plot: bool = False):
    ...
    def run_quantum_hardware(self, circuit, plot: bool = False):
